...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; }
    ...
    .toggle-control:hover .toggle-title {
      color: var(--ink);
    }
    ...
    .toggle-control input:checked ~ .toggle-copy .toggle-title {
      color: var(--ink);
    }
          ...
          <div class="meta-chip-row align-center">
            <label class="toggle-control">
              ...
              <span class="toggle-copy">
                <span class="toggle-title" data-i18n="summarize_starred_only">Summarize starred papers only (-B)</span>
              </span>
            </label>
          </div>
          <div class="topic-row">
